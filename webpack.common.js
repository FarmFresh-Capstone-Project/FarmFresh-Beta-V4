...
module.exports = {
  entry: {
    ...
    cart: path.resolve(__dirname, 'src/scripts/utils/cart.js'),
    checkout: path.resolve(__dirname, 'src/scripts/utils/checkout.js'),
    order: path.resolve(__dirname, 'src/scripts/utils/order.js'),
  },
  output: {
